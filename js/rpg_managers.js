...
Object.defineProperties(TextManager, {
    ...
    mainmenu        : TextManager.getter('command', 'mainmenu '),
    character       : TextManager.getter('command', 'character'),
    objectives      : TextManager.getter('command', 'objectives'),
    gold            : TextManager.getter('command', 'gold'),
...
BattleManager.isBattleScene = function() {
