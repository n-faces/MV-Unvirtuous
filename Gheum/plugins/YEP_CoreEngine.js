...
if (Yanfly.Param.CollectionClear) {
    ...
    Yanfly.Core.Scene_Control_terminate = Scene_Control.prototype.terminate;
    Scene_Control.prototype.terminate = function() {
        this._bypassFirstClear = true;
        Yanfly.Core.Scene_Control_terminate.call(this);
        this.clearChildren();
    };
